...
import nova.committee.talismans.common.morph.nbt.IMorphNBTHandler;
import nova.committee.talismans.common.morph.nbt.JsonMorphNBTHandler;
import nova.committee.talismans.common.morph.nbt.NBTPath;
...
{
    public static final JsonMorphNBTHandler DEFAULT_HANDLER = new JsonMorphNBTHandler(new CompoundTag(), new NBTPath[]{new NBTPath("CustomName")});
