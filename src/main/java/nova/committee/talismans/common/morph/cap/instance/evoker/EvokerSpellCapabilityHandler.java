...
import nova.committee.talismans.common.net.cap.EvokerSpell;

import java.util.ArrayList;

@EventBusSubscriber
public class EvokerSpellCapabilityHandler extends CommonCapabilityHandler<IEvokerSpellCapability, EvokerSpell.EvokerSpellPacket>
{
	...
	@Override
	protected EvokerSpell.EvokerSpellPacket createPacket(Player player, IEvokerSpellCapability capability)
	{
		return new EvokerSpell.EvokerSpellPacket(capability.getCastingTicksLeft());
	}
