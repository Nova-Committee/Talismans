...
public class FloatingLong extends Number implements Comparable<FloatingLong> {
    ...
    public long divideToLong(FloatingLong toDivide) {
        return clampUnsignedToLong(divideToUnsignedLong(toDivide));
    }
    ...
    public int divideToInt(FloatingLong toDivide) {
        return clampUnsignedToInt(divideToLong(toDivide));
    }
    ...
    @Override
    public int intValue() {
        return clampUnsignedToInt(value);
    }
    ...
    public long longValue() {
        return clampUnsignedToLong(value);
    }
    ...
    public float floatValue() {
        return unsignedLongToFloat(value) + decimal / (float) SINGLE_UNIT;
    }
    ...
    public double doubleValue() {
        return unsignedLongToDouble(value) + decimal / (double) SINGLE_UNIT;
    }
